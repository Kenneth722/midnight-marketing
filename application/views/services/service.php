<section id="hero" class="hero d-flex">
    <div class="container">
      <div class="row">
        <div class="col-xl-4">
          <h2 data-aos="fade-up"><?php echo $sub_category->name; ?></h2>
        ...
        <div class="col-xl-6 services-list" data-aos="fade-up" data-aos-delay="100">
          ...
          <?php foreach($service_details as $service) { ?>
            <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="100">
              ...
              <div>
                <h4 class="title"><a href="" class="stretched-link text-white"><?php echo $service->name; ?></a></h4>
              </div>
            </div>
          <?php } ?>
          </div>
        ...
        <div class="col-xl-1" data-aos="fade-up" data-aos-delay="100">
          <a href="services/addServiceView?id=<?php echo $sub_category->id; ?>"><i class="bi bi-plus" style="color: #ffffff;">Add New</i></a>
        </div>
      </div>
    </div>
